    ...
    ***************************************************************************** */
    ...
    function Panzoom(elem, options) {
        ...
        function zoomWithWheel(event, zoomOptions) {
			...
			vscal = setscal(zoomlevel);
			$("#minibox").height(start_mini_height*vscal).width(start_mini_width*vscal);
			miniviewwh();
			console.log("zoomlevel:"+zoomlevel+",toScale:"+toScale+",scale:"+scale+",vscal:"+vscal);
